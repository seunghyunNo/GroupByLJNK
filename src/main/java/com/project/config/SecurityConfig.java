    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return  http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/board/write/**", "/board/update/**", "/fileboard/write/**", "/fileboard/update/**", "/user/pwCheck","/user/update", "/user/myPage", "user/myBoard", "user/myFileBoard").hasAnyRole("MEMBER", "ADMIN")
                        .requestMatchers("/board/write/**", "/board/update/**", "/fileboard/write/**", "/fileboard/update/**", "/user/update", "/score/write", "/score/delete").hasAnyRole("MEMBER", "ADMIN")
                        // 그외 나머지 요청은 permit
